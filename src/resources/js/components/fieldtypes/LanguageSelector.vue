...
export default {
    ...
    mounted() {
        ...
        let supported = ['br', 'cs', 'da', 'de', 'en', 'es', 'fi', 'fr', 'hu', 'is', 'it', 'ja', 'lt', 'lv', 'nl', 'no', 'pl', 'pt', 'ro', 'ru', 'sv', 'zh'];
        ...
        supported.forEach((value) => {
            languages.registerLocale(require("@cospired/i18n-iso-languages/langs/" + value + ".json"));
        })

        const objectArray = Object.entries(languages.getNames(locale));
